...
\begin{frame}[t]
 ...
 \begin{itemize}
  ...
  \item<8-> At a critical point, we must have $\cos(x)\sin(y)=0$
   and $\sin(x)\cos(y)=0$.
 \ifx\HO\undefined
   \only<9>{Thus one of the following holds:
   \[ \begin{array}{lll}
...
\begin{frame}[t]
 ...
 \begin{center}
  \begin{tikzpicture}[scale=1]
   ...
   \draw ({\a+\c},{\b+\d}) node[anchor=south west] {$\ss\bsm a+c\\ b+d\esm$};
  ...
  \uc<2->{\begin{tikzpicture}[scale=1]
   ...
   \filldraw[fill=green!20,draw=black]
    (0,0) -- (\a,\b) -- ({\c+\a-\b*\c/\d},\d) -- (\c,\d) -- (0,0);
   \filldraw[fill=orange!70,draw=black]
    (0,0) -- ({\a-\b*\c/\d},0) -- (\a,\b) -- (0,0);
   \filldraw[fill=yellow!70,draw=black]
    (\c,\d) -- ({\c+\a-\b*\c/\d},\d) -- ({\a+\c},{\b+\d}) -- (\c,\d);
   \uc<4->{
     \filldraw[fill=green!20,draw=black]
      (0,0) -- ({\a-\b*\c/\d},0) -- (\a,\b) -- (0,0);
   ...
   \fill (\a,\b) circle(0.03);
   \fill (\c,\d) circle(0.03);
   \fill ({\a-\b*\c/\d}, 0) circle(0.03);
   \draw (\a,\b) node[anchor=south east] {$\ss\bsm a\\ b\esm$};
   \draw (\c,\d) node[anchor=south east] {$\ss\bsm c\\ d\esm$};
   \draw ({\a-\b*\c/\d}, 0) node[anchor=north] {$\ss\bsm u\\ 0\esm$};
  \end{tikzpicture}}
 \end{center}
...
\fi%
 ...
 \uc<5->{{\tiny \begin{align*}
    \det(J) &= \cos(\tht)\,\det\bbm r\cos(\tht) & 0 \\ 0 & 1 \ebm
\ifx\HO\undefined
    \only<5>{\dotsb}
\fi%
    \uc<6->{- (-r\sin(\tht)) \,\det\bbm \sin(\tht) & 0 \\ 0 & 1 \ebm}
\ifx\HO\undefined
    \only<6>{\dotsb}
\fi%
    \uc<7->{+ 0 \,\det\bbm \sin(\tht) & r\cos(\tht) \\ 0 & 0 \ebm }
    \only<7->{\WHITE{\dotsb}} \\
